...
if settings.SESSION_REDIS_CLUSTER_HOST is not None:

	redis_server = StrictRedisCluster(startup_nodes=settings.SESSION_REDIS_CLUSTER_HOST) 
...
class SessionStore(SessionBase):
	...
	def get_real_stored_key(self, session_key):
		...
		@return string
		"""
		prefix = settings.SESSION_REDIS_CLUSTER_PREFIX
		if not prefix:
			return session_key
